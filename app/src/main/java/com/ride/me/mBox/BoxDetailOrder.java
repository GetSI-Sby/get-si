...
//    TextView mBoxDetailPickup;
    ...
    @BindView(com.ride.me.R.id.detail_item)
    TextView mBoxDetailItem;

    @BindView(com.ride.me.R.id.detail_orglocation)
    TextView mBoxDetailOriginLoc;

    @BindView(com.ride.me.R.id.detail_destlocation)
...
//    Button mBoxBtnDiscount;
    ...
    @BindView(com.ride.me.R.id.detail_price)
    TextView mBoxDetailPrice;

//    @BindView(R.id.detail_discount)
//    TextView mBoxDetailDiscount;

    @BindView(com.ride.me.R.id.mpay_spinner)
    Spinner mPaySpinner;

    @BindView(com.ride.me.R.id.total_price)
    TextView mBoxTotalPrice;

    @BindView(com.ride.me.R.id.loading_service_price)
    TextView mBoxShipperPrice;

    @BindView(com.ride.me.R.id.insurance_price)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_mbox_detailorder);
...
//        mBoxDetailPickup.setText(tanggal+", "+jam+" WIB");
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                com.ride.me.R.array.mpay, android.R.layout.simple_spinner_item);
