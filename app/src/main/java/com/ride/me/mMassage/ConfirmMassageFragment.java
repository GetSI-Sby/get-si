...
import com.ride.me.model.DriverMassage;
...
import com.ride.me.utils.Utils;
...
public class ConfirmMassageFragment extends Fragment {
    ...
    @BindView(com.ride.me.R.id.confirmMassage_locationButton)
    LinearLayout locationButton;
    @BindView(com.ride.me.R.id.confirmMassage_locationText)
    TextView locationText;

    @BindView(com.ride.me.R.id.confirmMassage_dateTimeButton)
    LinearLayout dateTimeButton;
    @BindView(com.ride.me.R.id.confirmMassage_dateTimeText)
    TextView dateTimeText;

    @BindView(com.ride.me.R.id.confirmMassage_yourGenderText)
    TextView yourGenderText;
    @BindView(com.ride.me.R.id.confirmMassage_massageTypeText)
    TextView massageTypeText;
    @BindView(com.ride.me.R.id.confirmMassage_durationText)
    TextView durationText;
    @BindView(com.ride.me.R.id.confirmMassage_therapistPrefsText)
    TextView therapistText;

    @BindView(com.ride.me.R.id.confirmMassage_additionalNoteEditText)
    EditText additionalNoteEdit;

    @BindView(com.ride.me.R.id.confirmMassage_orderDetail)
    LinearLayout orderDetail;
    @BindView(com.ride.me.R.id.confirmMassage_price)
    TextView priceText;

    @BindView(com.ride.me.R.id.confirmMassage_paymentGroup)
    RadioGroup paymentGroup;

    @BindView(com.ride.me.R.id.confirmMassage_mPayBalance)
    TextView mPayBalance;

    @BindView(com.ride.me.R.id.confirmMassage_topUp)
    Button topUpButton;

    @BindView(com.ride.me.R.id.confirmMassage_order)
    Button orderButton;

    @BindView(com.ride.me.R.id.confirmMassage_mPayPayment)
    RadioButton mPayButton;

    @BindView(com.ride.me.R.id.confirmMassage_cashPayment)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.ride.me.R.layout.fragment_confirm_massage, container, false);
    }
...
//                }
    ...
    private void onOrderButtonClick() {
        switch (paymentGroup.getCheckedRadioButtonId()) {
            case com.ride.me.R.id.confirmMassage_cashPayment:
                orderMPay();
                break;
            case com.ride.me.R.id.confirmMassage_mPayPayment:
                order();
                break;
            default:
                break;
    ...
    private void orderMPay() {
        ...
        param.setPakaiMPay(paymentGroup.getCheckedRadioButtonId() == com.ride.me.R.id.confirmMassage_mPayPayment);
    ...
    private void formatDateTime() {
        if(calendar.getTimeInMillis() < Calendar.getInstance().getTimeInMillis() - (1 * 60 * 1000)) {
            Toast.makeText(activity, com.ride.me.R.string.massage_tanggalPesanan, Toast.LENGTH_SHORT).show();
