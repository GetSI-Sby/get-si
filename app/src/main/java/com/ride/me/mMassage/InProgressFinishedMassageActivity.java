...
import com.ride.me.model.DetailTransaksiMassage;
...
public class InProgressFinishedMassageActivity extends AppCompatActivity {
    ...
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_cancel)
    Button cancelOrderButton;
    @BindView(com.ride.me.R.id.btn_home)
    ImageView backButton;

    @BindView(com.ride.me.R.id.inProgressFinishedMassage_driverImage)
    ImageView driverImage;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_driverName)
    TextView driverName;

    @BindView(com.ride.me.R.id.inProgressFinishedMassage_contactContainer)
    LinearLayout contactContainer;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_phoneButton)
    ImageView phoneButton;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_messageButton)
    ImageView messageButton;

    @BindView(com.ride.me.R.id.inProgressFinishedMassage_dateTimeText)
    TextView dateTimeText;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_locationText)
    TextView locationText;

    @BindView(com.ride.me.R.id.inProgressFinishedMassage_massageTypeText)
    TextView massageType;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_durationText)
    TextView durationText;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_costText)
    TextView costText;
    @BindView(com.ride.me.R.id.inProgressFinishedMassage_statusText)
    TextView statusText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_inprogress_finished_massage);
