...
public class LocationPickerActivity extends AppCompatActivity
    ...
    @BindView(com.ride.me.R.id.locationPicker_currentAddress)
    TextView currentAddress;
    @BindView(com.ride.me.R.id.locationPicker_destinationButton)
...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_location_picker);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.ride.me.R.id.locationPicker_maps);
            ...
            for (Driver driver : driversAvailable) {
                ...
                driverMarkers.add(
                        gMap.addMarker(new MarkerOptions()
                                ...
                                .icon(BitmapDescriptorFactory.fromResource(com.ride.me.R.drawable.ic_massage_pin)))
                );
            }
        }
    }
                    ...
                    LocationPickerActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (!addresses.isEmpty()) {
                                ...
                                textView.setText(com.ride.me.R.string.text_addressNotAvailable);
                            }
                        }
                    });
                } catch (IOException e) {
