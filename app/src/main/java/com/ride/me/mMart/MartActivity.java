...
import com.ride.me.model.Pesanan;
...
/**
 * Created by David Studio on 12/3/2017.
 */
...
public class MartActivity extends AppCompatActivity
    ...
    @BindView(com.ride.me.R.id.mart_martName)
    EditText martName;
    @BindView(com.ride.me.R.id.btn_home)
    ImageView backButton;
    @BindView(com.ride.me.R.id.mart_martLocation)
    LinearLayout martGetLocationButton;
    @BindView(com.ride.me.R.id.mart_martLocationText)
    TextView martGetLocationText;

    @BindView(com.ride.me.R.id.mart_plusList)
    TextView productAdd;
    @BindView(com.ride.me.R.id.mart_minusList)
    TextView productRemove;
    @BindView(com.ride.me.R.id.mart_menuListRecycler)
    RecyclerView productListRecycler;

    @BindView(com.ride.me.R.id.mart_destinationButton)
    LinearLayout destinationGetLocationButton;
    @BindView(com.ride.me.R.id.mart_destinationText)
    TextView destinationGetLocationText;
    @BindView(com.ride.me.R.id.mart_detailsName)
    EditText destinationDetails;

    @BindView(com.ride.me.R.id.mart_estimatedCost)
    EditText estimatedCostEdit;

    @BindView(com.ride.me.R.id.mart_order)
    Button orderButton;

    @BindView(com.ride.me.R.id.mart_distance)
    TextView distanceText;

    @BindView(com.ride.me.R.id.mart_price)
    TextView priceText;

    @BindView(com.ride.me.R.id.mart_topUp)
    Button topUpButton;

    @BindView(com.ride.me.R.id.mart_detailOrder)
    LinearLayout detailOrder;

    @BindView(com.ride.me.R.id.mart_paymentGroup)
    RadioGroup paymentGroup;
    @BindView(com.ride.me.R.id.mart_mPayPayment)
    RadioButton mPayButton;
    @BindView(com.ride.me.R.id.mart_cashPayment)
    RadioButton cashButton;
    @BindView(com.ride.me.R.id.mart_mPayBalance)
...
//    DiskonMpay diskonMpay;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_mart);
...
//        diskonMpay = GoridemeAplication.getInstance(this).getDiskonMpay();
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.ride.me.R.id.map);
        ...
        paymentGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case com.ride.me.R.id.mart_mPayPayment:
                        ...
                        break;
                    case com.ride.me.R.id.mart_cashPayment:
                        biayaTotal = harga;
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(MartActivity.this, com.ride.me.R.color.directionLine))
                        .width(5));
