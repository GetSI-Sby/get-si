...
public class AddDetailSendActivity extends AppCompatActivity {
    ...
    TextView priceText;
    @BindView(com.ride.me.R.id.mSend_paymentGroup)
    RadioGroup paymentGroup;
    @BindView(com.ride.me.R.id.mSend_mPayPayment)
    RadioButton mPayButton;
    @BindView(com.ride.me.R.id.mSend_cashPayment)
    RadioButton cashButton;
    @BindView(com.ride.me.R.id.mSend_topUp)
    Button topUpButton;
    @BindView(com.ride.me.R.id.mSend_mPayBalance)
    TextView mPayBalanceText;
    @BindView(com.ride.me.R.id.mSend_order)
    Button orderButton;
    @BindView(com.ride.me.R.id.mSend_goods_description)
    EditText goodsDescription;
    @BindView(com.ride.me.R.id.mSend_sender_name)
    EditText senderName;
    @BindView(com.ride.me.R.id.mSend_sender_phone)
    EditText senderPhone;
    @BindView(com.ride.me.R.id.mSend_receiver_name)
    EditText receiverName;
    @BindView(com.ride.me.R.id.mSend_receiver_phone)
...
//    DiskonMpay diskonMpay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_send_add_detail);
        ...
        paymentGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case com.ride.me.R.id.mSend_mPayPayment:
                        long biayaTotal = (long)(price * fitur.getBiayaAkhir());
                        String formattedTotal = NumberFormat.getNumberInstance(Locale.US).format(biayaTotal);
                        String formattedText = String.format(Locale.US, "$ %s ,-", formattedTotal);
                        priceText.setText(formattedText);
                        break;
                    case com.ride.me.R.id.mSend_cashPayment:
                        biayaTotal = price;
