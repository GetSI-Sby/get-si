...
import com.ride.me.model.json.fcm.DriverRequest;
...
//                            updateDistance(distance);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_in_progress);
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(InProgressActivity.this, com.ride.me.R.color.directionLine))
                        .width(5));
            }
        } catch (Exception e) {
            e.printStackTrace();
