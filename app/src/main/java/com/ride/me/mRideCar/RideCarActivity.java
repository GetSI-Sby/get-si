...
/**
 * Created by David Studio on 10/26/2017.
 */
...
public class RideCarActivity extends AppCompatActivity
    ...
    @BindView(com.ride.me.R.id.rideCar_title)
    TextView title;
    @BindView(com.ride.me.R.id.btn_home)
    ImageView backButton;
    @BindView(com.ride.me.R.id.rideCar_pickUpContainer)
    LinearLayout setPickUpContainer;
    @BindView(com.ride.me.R.id.rideCar_destinationContainer)
    LinearLayout setDestinationContainer;
    @BindView(com.ride.me.R.id.rideCar_selector)
    RadioGroup rideCarSelector;
    @BindView(com.ride.me.R.id.rideCar_pickUpButton)
    Button setPickUpButton;
    @BindView(com.ride.me.R.id.rideCar_destinationButton)
    Button setDestinationButton;
    @BindView(com.ride.me.R.id.rideCar_pickUpText)
    AutoCompleteTextView pickUpText;
    @BindView(com.ride.me.R.id.rideCar_destinationText)
    AutoCompleteTextView destinationText;
    @BindView(com.ride.me.R.id.rideCar_detail)
    LinearLayout detail;
    @BindView(com.ride.me.R.id.rideCar_distance)
    TextView distanceText;
    @BindView(com.ride.me.R.id.container_price)
    RelativeLayout containerPrice;
    @BindView(com.ride.me.R.id.rideCar_price)
    TextView priceText;
    @BindView(com.ride.me.R.id.rideCar_paymentGroup)
    RadioGroup paymentGroup;
    @BindView(com.ride.me.R.id.rideCar_mPayPayment)
    RadioButton mPayButton;
    @BindView(com.ride.me.R.id.rideCar_cashPayment)
    RadioButton cashButton;
    @BindView(com.ride.me.R.id.rideCar_topUp)
    Button topUpButton;
    @BindView(com.ride.me.R.id.rideCar_order)
    Button orderButton;
    @BindView(com.ride.me.R.id.rideCar_mPayBalance)
    TextView mPayBalanceText;
    @BindView(com.ride.me.R.id.rideCar_select_car_container)
    RadioButton carSelectContainer;
    @BindView(com.ride.me.R.id.rideCar_select_ride_container)
    RadioButton rideSelectContainer;
    @BindView(com.ride.me.R.id.discountText)
...
//            new LatLng(8.015870, 142.285892)); // northeast
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_ride_car);
...
//        diskonMpay = GoridemeAplication.getInstance(this).getDiskonMpay();
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.ride.me.R.id.rideCar_mapView);
        ...
        paymentGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case com.ride.me.R.id.rideCar_mPayPayment:
                        ...
                        break;
                    case com.ride.me.R.id.rideCar_cashPayment:
                        biayaTotal = harga;
...
//        minPrice = designedFitur.getBiaya_minimum();
    ...
    private void updateFitur() {
        ...
        if (designedFitur.getIdFitur() == 1) {
            title.setText(com.ride.me.R.string.home_mRide);
        } else if (designedFitur.getIdFitur() == 2) {
            title.setText(com.ride.me.R.string.home_mCar);
        }
            ...
            for (Driver driver : driverAvailable) {
                ...
                if (designedFitur.getIdFitur() == 1) {
                    ...
                    driverMarkers.add(
                            gMap.addMarker(new MarkerOptions()
                                    .position(currentDriverPos)
                                    .icon(BitmapDescriptorFactory.fromResource(com.ride.me.R.drawable.ic_m_car_pin)))
                    );
                }
            }
        }
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(RideCarActivity.this, com.ride.me.R.color.directionLine))
                        .width(5));
