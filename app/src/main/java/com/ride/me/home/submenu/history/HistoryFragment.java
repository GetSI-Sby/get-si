...
public class HistoryFragment extends Fragment {
    ...
    @BindView(com.ride.me.R.id.history_tabLayout)
    SmartTabLayout historyTabLayout;

    @BindView(com.ride.me.R.id.history_viewPager)
    ViewPager historyViewPager;

    @BindView(com.ride.me.R.id.history_swipeRefresh)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.ride.me.R.layout.fragment_history, container, false);
    }
...
//
    ...
    public void changeFragment(Fragment frag, boolean addToBackStack) {
        ...
        transaction.replace(com.ride.me.R.id.history_viewPager, frag);
        if (addToBackStack) {
