package com.ride.me.home.submenu.home;
...
import com.ride.me.mBox.BoxActivity;
import com.ride.me.mBox.BoxOrder;
import com.ride.me.mFood.RestoranItemHome;
import com.ride.me.mMassage.MassageActivity;
import com.ride.me.mRideCar.RideCarActivity;
import com.ride.me.mSend.SendActivity;
import com.ride.me.model.DataRestoran;
import com.ride.me.model.PesananFood;
...
import com.ride.me.home.submenu.TopUpActivity;
import com.ride.me.mFood.FoodActivity;
import com.ride.me.mFood.FoodMenuActivity;
import com.ride.me.mFood.NearmeActivity;
import com.ride.me.mMart.MartActivity;
import com.ride.me.mService.mServiceActivity;
import com.ride.me.model.Banner;
import com.ride.me.model.Fitur;
import com.ride.me.model.KategoriRestoran;
import com.ride.me.model.KendaraanAngkut;
import com.ride.me.model.Restoran;
...
import com.ride.me.utils.ConnectivityUtils;
...
public class HomeFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks,
    ...
    @BindView(com.ride.me.R.id.home_mCar)
    RelativeLayout buttonMangCar;

    @BindView(com.ride.me.R.id.home_mRide)
    RelativeLayout buttonMangRide;

    @BindView(com.ride.me.R.id.home_mSend)
    RelativeLayout buttonMangSend;

    @BindView(com.ride.me.R.id.home_mBox)
    RelativeLayout buttonMangBox;

    @BindView(com.ride.me.R.id.home_mMart)
    RelativeLayout buttonMangMart;

    @BindView(com.ride.me.R.id.home_mMassage)
    RelativeLayout buttonMangMassage;

    @BindView(com.ride.me.R.id.home_mFood)
    RelativeLayout buttonMangFood;

    @BindView(com.ride.me.R.id.home_mService)
    RelativeLayout butonMangService;

    @BindView(com.ride.me.R.id.home_mPayBalance)
    TextView mPayBalance;

    @BindView(com.ride.me.R.id.home_topUpButton)
    Button topUpButton;

    @BindView(com.ride.me.R.id.slide_viewPager)
    AutoScrollViewPager slideViewPager;

    @BindView(com.ride.me.R.id.slide_viewPager_indicator)
    CircleIndicator slideIndicator;

    @BindView(com.ride.me.R.id.nearme_recycler)
    RecyclerView nearmeRecycler;

    @BindView(com.ride.me.R.id.nearme_progress)
    ProgressBar progress;

    @BindView(com.ride.me.R.id.show_more)
    TextView showMore;

    @BindView(com.ride.me.R.id.cargo_type_recyclerView)
    RecyclerView cargoTypeRecyclerView;

    @BindView(com.ride.me.R.id.show_more_box)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.ride.me.R.layout.fragment_home, container, false);
    }
    ...
    public void onResume() {
        ...
        if (!connectionAvailable) {
            if (snackbarController != null) snackbarController.showSnackbar(
                    com.ride.me.R.string.text_noInternet, Snackbar.LENGTH_INDEFINITE, com.ride.me.R.string.text_close,
