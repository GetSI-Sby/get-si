...
import com.ride.me.config.General;
...
import com.ride.me.home.submenu.history.details.MMartDetailActivity;
import com.ride.me.home.submenu.history.details.MSendDetailActivity;
...
import com.ride.me.service.GoridemeMessagingService;
...
public class HistoryDetailActivity extends AppCompatActivity
    ...
    TextView priceText;
    @BindView(com.ride.me.R.id.driver_image)
    RoundedImageView driverImage;
    @BindView(com.ride.me.R.id.driver_name)
    TextView driverName;
    @BindView(com.ride.me.R.id.order_number)
    TextView orderNumber;
    @BindView(com.ride.me.R.id.driver_police_number)
    TextView driverPoliceNumber;
    @BindView(com.ride.me.R.id.driver_car)
    TextView driverCar;
    @BindView(com.ride.me.R.id.driver_arriving_time)
    TextView driverArrivingTime;
    @BindView(com.ride.me.R.id.chat_driver)
    LinearLayout chatDriver;
    @BindView(com.ride.me.R.id.call_driver)
    LinearLayout callDriver;
    @BindView(com.ride.me.R.id.cancelBook)
    TextView cancelBook;
    @BindView(com.ride.me.R.id.splitter)
    View sparatorLayout;
    @BindView(com.ride.me.R.id.communication_layout)
    LinearLayout communicationLayout;
    @BindView(com.ride.me.R.id.price)
    RelativeLayout price;

    @BindView(com.ride.me.R.id.historyDetail_detail)
    Button detailButton;
...
//                            updateDistance(distance);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_history_detail);
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(HistoryDetailActivity.this, com.ride.me.R.color.directionLine))
                        .width(5));
            }
        } catch (Exception e) {
            e.printStackTrace();
...
//                new Queries(new DBHandler(getApplicationContext())).truncate(DBHandler.TABLE_CHAT);
    ...
    private void updateDriverMarker(LatLng latLng) {
        String fitur = transaction.order_fitur;
        int iconRes = com.ride.me.R.drawable.ic_m_ride_pin;
        if(fitur.equalsIgnoreCase("m-ride") || fitur.equalsIgnoreCase("m-send")
                || fitur.equalsIgnoreCase("m-mart")
                || fitur.equalsIgnoreCase("m-food")) {
            iconRes = com.ride.me.R.drawable.ic_m_ride_pin;
        } else if(fitur.equalsIgnoreCase("m-car")) {
            iconRes = com.ride.me.R.drawable.ic_m_car_pin;
        } else if(fitur.equalsIgnoreCase("m-massage")) {
            iconRes = com.ride.me.R.drawable.ic_massage_pin;
        } else if(fitur.equalsIgnoreCase("m-box")) {
            iconRes = com.ride.me.R.drawable.ic_mbox_pin;
        } else if(fitur.equalsIgnoreCase("m-service")) {
            iconRes = com.ride.me.R.drawable.ic_service_pin;
        }
