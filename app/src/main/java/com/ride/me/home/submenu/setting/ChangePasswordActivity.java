...
public class ChangePasswordActivity extends DialogActivity {
    @BindView(com.ride.me.R.id.current_password)
    EditText currentpassword;
    @BindView(com.ride.me.R.id.new_password)
    EditText newPassword;
    @BindView(com.ride.me.R.id.confirm_new_password)
    EditText confirmNewPassword;
    @BindView(com.ride.me.R.id.change_password)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_change_password);
