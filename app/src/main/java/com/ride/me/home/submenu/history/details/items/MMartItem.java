package com.ride.me.home.submenu.history.details.items;
...
public class MMartItem extends AbstractItem<MMartItem, MMartItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return com.ride.me.R.id.itemMMart;
    }

    @Override
    public int getLayoutRes() {
        return com.ride.me.R.layout.item_mmart;
    }
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.ride.me.R.id.itemMMart_nama)
        TextView namaBarang;
        @BindView(com.ride.me.R.id.itemMMart_qty)
        TextView qty;
