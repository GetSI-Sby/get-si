...
public class SettingFragment extends Fragment {
    ...
    @BindView(com.ride.me.R.id.setting_name)
    TextView settingProfileName;

    @BindView(com.ride.me.R.id.setting_email)
    TextView settingProfileEmail;

    @BindView(com.ride.me.R.id.setting_phone)
    TextView settingProfilePhone;

    @BindView(com.ride.me.R.id.setting_editProfile)
    Button settingEditProfile;

    @BindView(com.ride.me.R.id.setting_changePassword)
    LinearLayout settingChangePassword;

    @BindView(com.ride.me.R.id.setting_termOfService)
    LinearLayout settingTermOfService;

    @BindView(com.ride.me.R.id.setting_privacyPolicy)
    LinearLayout settingPrivacyPolicy;

    @BindView(com.ride.me.R.id.setting_faq)
    LinearLayout settingFaq;



    @BindView(com.ride.me.R.id.setting_rateThisApps)
    LinearLayout settingRateThisApps;

    @BindView(com.ride.me.R.id.setting_logout)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.ride.me.R.layout.fragment_setting, container, false);
    }
