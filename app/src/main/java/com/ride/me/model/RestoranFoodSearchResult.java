...
public class RestoranFoodSearchResult extends AbstractItem<RestoranFoodSearchResult, RestoranFoodSearchResult.ViewHolder> {
    ...
    @Override
    public int getType() {
        return com.ride.me.R.id.restoranFoodSearchResult;
    }

    @Override
    public int getLayoutRes() {
        return com.ride.me.R.layout.item_restoran_food_search_result;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.ride.me.R.id.restoranFoodSearchResult_content)
        TextView content;

        @BindView(com.ride.me.R.id.restoranFoodSearchResult_description)
        TextView description;

        @BindView(com.ride.me.R.id.restoranFoodSearchResult_distance)
        TextView distance;
