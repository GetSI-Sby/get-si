...
import static com.ride.me.service.GoridemeMessagingService.BROADCAST_ORDER;
...
public class mServiceProgress extends AppCompatActivity {
    ...
    @BindView(com.ride.me.R.id.text_ordernum)
    ...
    @BindView(com.ride.me.R.id.driver_number)
    TextView driverNumber;

    @BindView(com.ride.me.R.id.btn_chat)
    LinearLayout btnChat;

    @BindView(com.ride.me.R.id.btn_call)
    LinearLayout btnCall;

    @BindView(com.ride.me.R.id.value_service)
    TextView textService;

    @BindView(com.ride.me.R.id.value_actype)
    TextView textActype;

    @BindView(com.ride.me.R.id.value_quantity)
    TextView textQuantity;

    @BindView(com.ride.me.R.id.value_problem)
    TextView textProblem;

    @BindView(com.ride.me.R.id.value_location)
    TextView textLocation;

    @BindView(com.ride.me.R.id.value_price)
    TextView textPrice;

    @BindView(com.ride.me.R.id.btn_cancel)
    Button btnCancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_mservice_progress);
