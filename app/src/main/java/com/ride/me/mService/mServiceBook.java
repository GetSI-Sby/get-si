...
public class mServiceBook extends AppCompatActivity
    ...
    @BindView(com.ride.me.R.id.mService_location)
    AutoCompleteTextView setLocation;

    @BindView(com.ride.me.R.id.mService_locbtn)
    Button setLocButton;

    @BindView(com.ride.me.R.id.service_paymentgroup)
    RadioGroup paymentGroup;

    @BindView(com.ride.me.R.id.service_cash)
    RadioButton serviceCash;

    @BindView(com.ride.me.R.id.service_mpay)
    RadioButton serviceMpay;

    @BindView(com.ride.me.R.id.mpay_balance)
    TextView textMpay;

    @BindView(com.ride.me.R.id.service_pricetag)
    TextView textPrice;

    @BindView(com.ride.me.R.id.service_topup)
    Button topupButton;
...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_mservice_book);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.ride.me.R.id.mService_map);
        ...
        paymentGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case com.ride.me.R.id.service_mpay:
                        pakaiMpay = 1;
                        ...
                        break;
                    case com.ride.me.R.id.service_cash:
                        pakaiMpay = 0;
                        biayaTotal = harga;
    ...
    private void onSetLocationClick() {
        ...
        orderButton.setBackgroundResource(com.ride.me.R.color.colorPrimary);
    }
            ...
            for (Driver driver : driverAvailable) {
                ...
                driverMarkers.add(
                        gMap.addMarker(new MarkerOptions()
                                ...
                                .icon(BitmapDescriptorFactory.fromResource(com.ride.me.R.drawable.ic_service_pin)))
                );
            }
        }
    }
