...
import com.ride.me.model.DataMservice;
import com.ride.me.model.JenisService;
import com.ride.me.model.TipeAC;
...
public class mServiceActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    @NotEmpty
    @BindView(com.ride.me.R.id.service_form)
    EditText serviceForm;

    @NotEmpty
    @BindView(com.ride.me.R.id.actype_form)
    EditText actypeForm;

    @NotEmpty
    @BindView(com.ride.me.R.id.quantity_form)
    EditText quantityForm;

    @NotEmpty
    @BindView(com.ride.me.R.id.residential_form)
    EditText residentialForm;

    @BindView(com.ride.me.R.id.problem_form)
    EditText problemForm;

    @BindView(com.ride.me.R.id.mService_btnnext)
    Button nextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_mservice);
