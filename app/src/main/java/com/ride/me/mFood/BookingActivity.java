...
import com.ride.me.model.Makanan;
...
public class BookingActivity extends AppCompatActivity implements MakananItem.OnCalculatePrice {
    ...
    @BindView(com.ride.me.R.id.food_orders)
    RecyclerView foodOrders;

    @BindView(com.ride.me.R.id.booking_location)
    LinearLayout locationButton;
    @BindView(com.ride.me.R.id.food_destination)
    TextView locationText;
    @BindView(com.ride.me.R.id.food_addNotes)
    EditText addNotes;

    @BindView(com.ride.me.R.id.food_cost)
    TextView foodCost;
    @BindView(com.ride.me.R.id.delivery_cost)
    TextView deliveryCost;
    @BindView(com.ride.me.R.id.value_service)
    TextView totalCost;
    @BindView(com.ride.me.R.id.food_cash)
    TextView cashCost;

    @BindView(com.ride.me.R.id.service_paymentgroup)
    RadioGroup paymentGroup;
    @BindView(com.ride.me.R.id.radio_mpay)
    RadioButton mpayPayment;
    @BindView(com.ride.me.R.id.radio_cash)
    RadioButton cashPayment;
    @BindView(com.ride.me.R.id.mpay_balance)
    TextView mPayBalance;
    @BindView(com.ride.me.R.id.mpay_discount)
    TextView mPayDiscount;
    @BindView(com.ride.me.R.id.add_food)
    TextView addFood;
    @BindView(com.ride.me.R.id.mpay_topup)
    Button topupButton;

    @BindView(com.ride.me.R.id.order_btn)
    Button orderButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_booking);
        ...
        pesananAdapter.withItemEvent(new ClickEventHook<MakananItem>() {
            ...
            public void onClick(View v, int position, FastAdapter<MakananItem> fastAdapter, MakananItem item) {
                ...
                dialog.setContentView(com.ride.me.R.layout.dialog_header_polygon);
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                dialog.setCancelable(true);
                TextView text = (TextView) dialog.findViewById(com.ride.me.R.id.titledialog);
                text.setText(selectedMakanan.getNamaMenu());
                TextView textdesc = (TextView) dialog.findViewById(com.ride.me.R.id.descdialog);
                textdesc.setText(selectedMakanan.getDeskripsiMenu());
                TextView textprice = (TextView) dialog.findViewById(com.ride.me.R.id.pricedialog);
                textprice.setText("Price: $"+" "+String.valueOf(selectedMakanan.getHarga()));
                ImageView image = (ImageView) dialog.findViewById(com.ride.me.R.id.image);
                Glide.with(BookingActivity.this).asBitmap().load(selectedMakanan.getFoto())
//                        .animate(com.ride.me.R.anim.abc_fade_in)
                        .into(image);

                TextView dialogButton = (TextView) dialog.findViewById(com.ride.me.R.id.bt_decline);
                /**
    ...
    private void sendOrder() {
        ...
        param.setPakaiMPay(paymentGroup.getCheckedRadioButtonId() == com.ride.me.R.id.radio_mpay);
    ...
    private void updateCostPrice() {
        ...
        if(paymentGroup.getCheckedRadioButtonId() == com.ride.me.R.id.radio_mpay) {
            if(isRestoranMitra) {
