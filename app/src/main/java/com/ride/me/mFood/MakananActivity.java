...
public class MakananActivity extends AppCompatActivity implements MakananItem.OnCalculatePrice {
    ...
    @BindView(com.ride.me.R.id.menu_title)
    TextView menuTitle;

    @BindView(com.ride.me.R.id.makanan_recycler)
    RecyclerView makananRecycler;

    @BindView(com.ride.me.R.id.price_container)
    CardView priceContainer;

    @BindView(com.ride.me.R.id.qty_text)
    TextView qtyText;

    @BindView(com.ride.me.R.id.cost_text)
    TextView costText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_makanan);
        ...
        makananAdapter.withItemEvent(new ClickEventHook<MakananItem>() {
            ...
            public void onClick(View v, int position, FastAdapter<MakananItem> fastAdapter, MakananItem item) {
                ...
                Glide.with(MakananActivity.this).asBitmap().load(selectedMakanan.getFoto())
                        .into(image);
