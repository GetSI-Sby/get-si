...
public class SearchRestoranActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    @BindView(com.ride.me.R.id.searchRestoran_searchQuery)
    EditText searchQuery;

    @BindView(com.ride.me.R.id.searchRestoran_searchResult)
    RecyclerView searchResult;

    @BindView(com.ride.me.R.id.searchRestoran_requirement)
    TextView requirement;

    @BindView(com.ride.me.R.id.searchRestoran_noResult)
    CardView noResult;

    @BindView(com.ride.me.R.id.searchRestoran_progress)
    ...
    private Dialog LoadingSpinner(Context mContext){
        ...
        View view = LayoutInflater.from(mContext).inflate(com.ride.me.R.layout.dialog_progress, null);
        pd.requestWindowFeature(Window.FEATURE_NO_TITLE);
        pd.getWindow().setBackgroundDrawableResource(com.ride.me.R.color.transparent);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_search_restoran);
