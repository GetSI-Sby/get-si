...
/**
 * Created by David Studio on 1/3/2017.
 */
...
public class MakananItem extends AbstractItem<MakananItem, MakananItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return com.ride.me.R.id.makanan_item;
    }
    ...
    public void bindView(final MakananItem.ViewHolder holder, List payloads) {
        ...
        Glide.with(context).load(foto).into(holder.image);
    ...
    public int getLayoutRes() {
        return com.ride.me.R.layout.item_makanan;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(com.ride.me.R.id.makanan_text)
        TextView makananText;

        @BindView(com.ride.me.R.id.deskripsi_text)
        TextView deskripsiText;

        @BindView(com.ride.me.R.id.harga_text)
        TextView hargaText;

        @BindView(com.ride.me.R.id.notes_text)
        EditText notesText;

        @BindView(com.ride.me.R.id.add_quantity)
        TextView addQuantity;

        @BindView(com.ride.me.R.id.quantity_text)
        TextView quantityText;

        @BindView(com.ride.me.R.id.image)
        ImageView image;

        @BindView(com.ride.me.R.id.remove_quantity)
        TextView removeQuantity;

        @BindView(com.ride.me.R.id.makanan_item)
