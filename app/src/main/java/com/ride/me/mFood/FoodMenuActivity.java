...
import com.ride.me.model.FoodResto;
import com.ride.me.model.MenuMakanan;
...
public class FoodMenuActivity extends AppCompatActivity {
    ...
    @BindView(com.ride.me.R.id.resto_name)
    TextView titleName;

    @BindView(com.ride.me.R.id.food_img)
    ImageView foodImage;

    @BindView(com.ride.me.R.id.food_address)
    TextView foodAddress;

    @BindView(com.ride.me.R.id.food_info)
    TextView foodInfo;

    @BindView(com.ride.me.R.id.menu_recycler)
    RecyclerView menuRecycler;

    @BindView(com.ride.me.R.id.foodMenu_bottom)
    ...
    @BindView(com.ride.me.R.id.foodMenu_mitra)
    TextView mitra;

    @BindView(com.ride.me.R.id.foodMenu_closed)
    TextView closed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_food_menu);
        ...
        options.centerCrop();
        Glide.with(this).load(picUrl).apply(options).into(foodImage);
        if(isOpenFromParent) {
    ...
    private void initToolbar() {
        ...
        toolbar.setTitleTextColor(ContextCompat.getColor(this, com.ride.me.R.color.white));
    }
