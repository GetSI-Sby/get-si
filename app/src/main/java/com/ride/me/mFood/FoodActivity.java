...
import com.ride.me.model.PromosiMFood;
...
public class FoodActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    @BindView(com.ride.me.R.id.food_search)
    LinearLayout foodSearch;

    @BindView(com.ride.me.R.id.food_nearme)
    LinearLayout foodNearme;

    @BindView(com.ride.me.R.id.food_manual)
    LinearLayout foodManual;

    @BindView(com.ride.me.R.id.food_explore)
    RelativeLayout foodExplore;

    @BindView(com.ride.me.R.id.text_explore)
    TextView textExplore;

    @BindView(com.ride.me.R.id.show_more2)
    TextView showMore2;
    ...
    @BindView(com.ride.me.R.id.kategori_recycler)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ride.me.R.layout.activity_food);
