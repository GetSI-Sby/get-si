...
/**
 * Created by David Studio on 12/29/2017.
 */
...
public class RestoranItem extends AbstractItem<RestoranItem, RestoranItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return com.ride.me.R.id.nearme_item;
    }
    ...
    public int getLayoutRes() {
        return com.ride.me.R.layout.item_nearme;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(com.ride.me.R.id.nearme_img)
        ImageView nearmeIMG;

        @BindView(com.ride.me.R.id.nearme_resto)
        TextView nearmeResto;

        @BindView(com.ride.me.R.id.nearme_address)
        TextView nearmeAddress;

        @BindView(com.ride.me.R.id.nearme_info)
        TextView nearmeInfo;

        @BindView(com.ride.me.R.id.nearme_closed)
        TextView closed;

        @BindView(com.ride.me.R.id.nearme_mitra)
        TextView partner;
